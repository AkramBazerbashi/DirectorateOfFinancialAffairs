import { TBLShamelPunishmentReasonService } from '../../../../shared/services/employees_department/tblshamel-punishment-reason.service';
import { TBLShamelPunishmentService } from '../../../../shared/services/employees_department/tblshamel-punishment.service';
...
import { ITBLShamelPunishmentReason } from '../../../../shared/models/employees_department/ITBLShamelPunishmentReason';
import { ITBLShamelPunishment } from '../../../../shared/models/employees_department/ITBLShamelPunishment';
...
export class TblshamelscpunishmentmodifyComponent implements OnInit,AfterViewInit {
  ...
  ngAfterViewInit() {
   ...
   public BuildForm()
   {
    ...
    if (this.Selected_Employee_SCPunishment && this.Selected_Employee_SCPunishment.serial>0)
    {

    
      this.punishment_id   = new FormControl({value: this.Selected_Employee_SCPunishment.punishment_id, disabled: false},[Validators.required, Validators.minLength(5)]);            
      this.reason_id  = new FormControl(this.Selected_Employee_SCPunishment.reason_id ,[ Validators.required ]);
      this.documenttype_id   = new FormControl(this.Selected_Employee_SCPunishment.documenttype_id ,[ Validators.required ]);
      this.document_number = new FormControl(this.Selected_Employee_SCPunishment.document_number,[ Validators.required ]);      
      this.documentdate = new FormControl(moment(this.Selected_Employee_SCPunishment.documentdate) ,[ Validators.required ]);
...
this.Form.patchValue(
  {
    ...
    reason_id:this.Selected_Employee_SCPunishment.reason_id,
    punishment_id:this.Selected_Employee_SCPunishment.punishment_id,    
    documenttype_id:this.Selected_Employee_SCPunishment.documenttype_id,   
    documentdate:moment(this.Selected_Employee_SCPunishment.documentdate) ,
    document_number:this.Selected_Employee_SCPunishment.document_number,
...
this.documentdate.setValue(moment(this.Selected_Employee_SCPunishment.documentdate));
...
//    this.enddate.setValue(moment(this.Selected_Employee_SCPunishment.enddate).format('YYYY/MM/DD') );
  ...
  console.log(this.Selected_Employee_SCPunishment.document_number);
...
if (this.Selected_Employee_SCPunishment )
{
  ...
  this.Selected_Employee_SCPunishment.id = this.id;
    ...
    this.Selected_Employee_SCPunishment.documentdate = moment(this.documentdate.value).format('YYYY/MM/DD');
...
//#endregion
  ...
  {
    if (!this.Selected_Employee_SCPunishment)
    this.Selected_Employee_SCPunishment = new ITBLShamelSCPunishment();
    this.Selected_Employee_SCPunishment.init();  
    this.Selected_Employee_SCPunishment.id= this.id ; 
  }
...
*/
   ...
   else if (this.Selected_Employee_SCPunishment  &&
             this.Selected_Employee_SCPunishment.serial>0)
             {
               console.log('update');
               console.log(this.Selected_Employee_SCPunishment);
...
addEventDocumentDate(type: string, event: MatDatepickerInputEvent<Date>) {
  ...
  this.Selected_Employee_SCPunishment.documentdate = moment(event.value).format('YYYY/MM/DD');
  console.log('addEventDocumentDate');
